...
** BROKEN Emacs Application Framework
*** Keys
| Key           | Event                                       |
|---------------+---------------------------------------------|
| C--           | zoom_out                                    |
...
;;                 (org-agenda-files '(,("~/work/wiki" "~/work/Inbox.org" "~/tmsg/delivery.org" "~/twork")))
...
(use-package ox-hugo
  :ensure t)
qs(setq org-hugo-base-dir "/home/alex/work/org-share")
#+END_SRC

#+RESULTS:
: /home/alex/work/org-share
